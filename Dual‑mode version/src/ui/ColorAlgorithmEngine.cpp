...
LabColor ColorAlgorithmEngine::rgbToLab(const QColor& color) {
...
double ColorAlgorithmEngine::calculateDeltaE(const QColor& c1, const QColor& c2) {
...
QColor ColorAlgorithmEngine::extractDominantColorFromImage(const QImage& preScaledImage) {
    auto palette = extractPaletteFromImage(preScaledImage);
